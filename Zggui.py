...
# Header
    ...
    with st.container():
        ...
        st.markdown("<style>.stTextInput>div>div>input { width: calc(100% - 80px) !important; }</style>", unsafe_allow_html=True)

    user_input = st.text_input("Ask me anything about bob services...", value=st.session_state.get('user_input', ''))
